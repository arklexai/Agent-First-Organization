...
def check_available(
    ...
    **kwargs: Dict[str, Any],
    ...
    try:
        ...
        last_day: int = calendar.monthrange(
            meeting_date.year, meeting_date.month)[1]
        ...
        try:
            ...
            availability_response: Dict[str,
                                        Any] = availability_response.json()
            ...
            slots: List[Dict[str, Any]] = availability.get(
                "availabilities", [])
            ...
            same_dt_info: Dict[str, List[Dict[str, str]]] = {
