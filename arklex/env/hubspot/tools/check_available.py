...
def check_available(owner_id: str, time_zone: str, meeting_date: str, duration: int, **kwargs) -> str:
    ...
    try:
        ...
        try:
            ...
            availability = availability_response.get("linkAvailability", {}).get(
                "linkAvailabilityByDuration", {}).get(duration_ms, {})
            ...
            for ab_time in ab_times:
                start_dt = datetime.fromtimestamp(
                    ab_time['start'] / 1000, tz=pytz.utc).astimezone(time_zone)
