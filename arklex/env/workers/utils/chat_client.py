...
async_result: Future[Any] = Future()
...
class ChatClient:
    ...
    def __init__(
        ...
        server_port: Union[str, int] = "8888",
        *,
        ...
        self.server_port: Union[str, int] = server_port
        ...
        self.async_result: Future[Any] = Future()
    ...
    async def main(self, message: Optional[str] = None) -> str:
        ...
        read_task: Optional[asyncio.Task[Any]] = None
        write_task: Optional[asyncio.Task[Any]] = None
