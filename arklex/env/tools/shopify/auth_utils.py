...
AUTH_ERROR: str = "error: cannot retrieve access token"
...
verifier: str = generateCodeVerifier()
challenge: str = generateCodeChallenge(verifier)
state: str = generateState()

clientID: Optional[str] = os.environ.get("SHOPIFY_CLIENT_ID")
shop_id: str = "60183707761"
redirect_uri: str = "https://causal-bluejay-humble.ngrok-free.app/callback"

auth_url: str = f"https://shopify.com/authentication/{shop_id}/oauth/authorize"
...
def get_auth_link(redirect_uri: str = redirect_uri) -> str:
    params: Dict[str, str] = auth_params.copy()
...
token_url: str = f"https://shopify.com/authentication/{shop_id}/oauth/token"
...
def get_refresh_token(code: str) -> str:
    params: Dict[str, str] = token_params.copy()
    params["code"] = code
    response: requests.Response = requests.post(token_url, params=params)
...
def get_access_token(refresh_token: str) -> str:
    params: Dict[str, str] = refresh_params.copy()
