...
class ShopifySlots:
    ...
    PRODUCT_IDS: Dict[str, Any] = to_list(PRODUCT_ID)

    CART_ID: Dict[str, Any] = {
        "name": "cart_id",
        "type": "str",
...
class ShopifyCartAddItemsSlots(ShopifySlots):
    CART_ID: Dict[str, Any] = {**ShopifySlots.CART_ID, "required": True}
    PRODUCT_VARIANT_IDS: Dict[str, Any] = ShopifySlots.to_list(
        {
...
class ShopifyGetOrderDetailsSlots(ShopifySlots):
    USER_ID: Dict[str, Any] = {**ShopifySlots.USER_ID, "required": True}
    ORDER_IDS: Dict[str, Any] = ShopifySlots.to_list(
        {
            "name": "order_id",
            "type": "str",
    ...
    ORDER_NAMES: Dict[str, Any] = ShopifySlots.to_list(
        {
            "name": "order_name",
            "type": "str",
...
class ShopifyGetProductsSlots(ShopifySlots):
    PRODUCT_IDS: Dict[str, Any] = {**ShopifySlots.PRODUCT_IDS, "required": True}
...
class ShopifySearchProductsSlots(ShopifySlots):
    SEARCH_PRODUCT_QUERY: Dict[str, Any] = {
        "name": "product_query",
        "type": "str",
...
class ShopifyOutputs:
    ...
    COLLECTIONS_DETAILS: Dict[str, Any] = {
        "name": "cart",
        "type": "dict",
        "required": True,
    ...
    RETURN_REQUEST_DETAILS: Dict[str, Any] = {
        "name": "return_request",
        "type": "dict",
        "required": True,
    ...
    CANECEL_REQUEST_DETAILS: Dict[str, Any] = {
        "name": "cancel_request",
        "type": "dict",
        "required": True,
    ...
    CART_ADD_ITEMS_DETAILS: Dict[str, Any] = {
        "name": "cart_add_items",
        "type": "dict",
        "required": True,
