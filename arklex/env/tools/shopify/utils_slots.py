from typing import Dict, List, Any, Union, TypeVar, ClassVar
...
class ShopifySlots:
    @staticmethod
    def to_list(baseSlot: Dict[str, Any]) -> Dict[str, Any]:
        slot: Dict[str, Any] = baseSlot.copy()
        slot["name"] += "s"
    ...
    @classmethod
    def get_all_slots(cls) -> List[Union[Dict[str, Any], List[Any]]]:
        return [
            slot
    ...
    PRODUCT_ID: ClassVar[Dict[str, Any]] = {
        "name": "product_id",
        "type": "str",
    ...
    PRODUCT_IDS: ClassVar[Dict[str, Any]] = to_list(PRODUCT_ID)

    CART_ID: ClassVar[Dict[str, Any]] = {
        "name": "cart_id",
        "type": "str",
...
class ShopifyCancelOrderSlots(ShopifySlots):
    CANCEL_ORDER_ID: ClassVar[Dict[str, Any]] = {
...
class ShopifyCartAddItemsSlots(ShopifySlots):
    CART_ID: ClassVar[Dict[str, Any]] = {**ShopifySlots.CART_ID, "required": True}
    PRODUCT_VARIANT_IDS: ClassVar[Dict[str, Any]] = ShopifySlots.to_list(
        {
...
class ShopifyFindUserByEmailSlots(ShopifySlots):
    USER_EMAIL: ClassVar[Dict[str, Any]] = {
        "name": "user_email",
        "type": "str",
...
class ShopifyGetOrderDetailsSlots(ShopifySlots):
    USER_ID: ClassVar[Dict[str, Any]] = {**ShopifySlots.USER_ID, "required": True}
    ORDER_IDS: ClassVar[Dict[str, Any]] = ShopifySlots.to_list(
        {
            "name": "order_id",
            "type": "str",
    ...
    ORDER_NAMES: ClassVar[Dict[str, Any]] = ShopifySlots.to_list(
        {
            "name": "order_name",
            "type": "str",
...
class ShopifyGetProductsSlots(ShopifySlots):
    PRODUCT_IDS: ClassVar[Dict[str, Any]] = {
...
class ShopifyGetWebProductSlots(ShopifySlots):
    WEB_PRODUCT_ID: ClassVar[Dict[str, Any]] = {
        "name": "web_product_id",
        "type": "str",
...
class ShopifyReturnProductsSlots(ShopifySlots):
    RETURN_ORDER_ID: ClassVar[Dict[str, Any]] = {
...
class ShopifySearchProductsSlots(ShopifySlots):
    SEARCH_PRODUCT_QUERY: ClassVar[Dict[str, Any]] = {
        "name": "product_query",
        "type": "str",
...
class ShopifyOutputs:
    ...
    FULFILLMENT_ID: ClassVar[Dict[str, Any]] = {
        "name": "fulfillment_id",
        "type": "string",
        "required": True,
    ...
    USER_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "user_details",
        "type": "dict",
        "required": True,
    ...
    PRODUCTS_DETAILS: ClassVar[Dict[str, Any]] = {
    ...
    ORDERS_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "order_details",
        "type": "dict",
        "required": True,
    ...
    COLLECTIONS_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "cart",
        "type": "dict",
        "required": True,
    ...
    RETURN_REQUEST_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "return_request",
        "type": "dict",
        "required": True,
    ...
    CANECEL_REQUEST_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "cancel_request",
        "type": "dict",
        "required": True,
    ...
    GET_CART_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "get_cart",
        "type": "dict",
        "required": True,
    ...
    CART_ADD_ITEMS_DETAILS: ClassVar[Dict[str, Any]] = {
        "name": "cart_add_items",
        "type": "dict",
        "required": True,
