...
description: str = "Find user id by refresh token. If the user is not found, the function will return an error message."
...
errors: List[str] = [AUTH_ERROR, USER_NOT_FOUND_ERROR]
...
def get_user_id(refresh_token: str) -> str:
    try:
