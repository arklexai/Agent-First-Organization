...
def start_auth_server() -> None:
    ...
    def callback() -> str:
        ...
        token: Optional[str] = request.args.get("code")
        ...
        shutdown_func: Optional[Any] = request.environ.get("werkzeug.server.shutdown")
        if shutdown_func:
            shutdown_func()
