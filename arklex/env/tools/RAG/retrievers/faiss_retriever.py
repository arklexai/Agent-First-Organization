...
class FaissRetrieverExecutor:
    def __init__(
        ...
        self.embedding_model: Union[OpenAIEmbeddings, Any] = PROVIDER_EMBEDDINGS.get(
        ...
        self.llm: Union[ChatOpenAI, Any] = PROVIDER_MAP.get(
            llm_config.llm_provider, ChatOpenAI
        )(model=llm_config.model_type_or_path)
        self.retriever: Any = self._init_retriever()
    ...
    def _init_retriever(self, **kwargs: Any) -> Any:
        ...
        retriever: Any = docsearch.as_retriever(**kwargs)
        return retriever
