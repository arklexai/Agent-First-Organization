...
class ConditionTracer:
    ...
    def record_primitive(  # noqa: ANN201
        self,
        *,
        param: str,
        operator: str,
...
class SubTaskGraphLogic(TaskGraphBase):
    ...
    def _evaluate_logic(self, curr_node: str, params: OrchestratorParams) -> str | None:
        ...
        """
        log_context.info(f"[LogicEdge] Evaluating logic edges at node {curr_node}")
    ...
    def _deep_get(self, obj: Any, path: str, default: Any = None) -> Any:  # noqa: ANN401
    ...
    def _eval_primitive(
        ...
        - param: dot-path into OrchestratorParams (e.g., metadata.turn_id)
        - op: one of eq, ne, gt, gte, lt, lte, contains, regex, exists
