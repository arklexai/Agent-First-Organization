...
class AgentOrg:
    ...
    def init_params(
        ...
        Args:
            inputs (Dict[str, Any]): Input parameters containing text, chat history, and other parameters.

        Returns:
            Tuple[str, str, Params, MessageState]: A tuple containing the text, formatted chat history,
                                                parameters, and message state.
        """
    ...
    def post_process_node(
        ...
        """Post-process a node after it has been executed.

        Args:
            node_info (NodeInfo): Information about the node.
            params (Params): Current parameters.
            update_info (Dict[str, Any], optional): Additional update information. Defaults to {}.
    ...
    def handl_direct_node(
        ...
        Returns:
            Tuple[bool, Optional[OrchestratorResp], Params]: A tuple containing whether the node was handled,
                                                          the response if any, and updated parameters.
        """
    ...
    def perform_node(
        ...
        """Perform a node's action.

        Args:
            message_state (MessageState): Current message state.
            node_info (NodeInfo): Information about the node.
            params (Params): Current parameters.
            text (str): Input text.
            chat_history_str (str): Formatted chat history.
            stream_type (Optional[StreamType]): Type of streaming if any.
            message_queue (Optional[janus.SyncQueue]): Message queue for streaming.

        Returns:
            Tuple[NodeInfo, MessageState, Params]: Updated node info, message state, and parameters.
        """
        # Tool/Worker
    ...
    def handle_nested_graph_node(
        ...
        Returns:
            Tuple[NodeInfo, Params]: Updated node info and parameters.
        """
    ...
    def _get_response(
        ...
        Args:
            ...
            stream_type (Optional[StreamType], optional): Type of streaming if any. Defaults to None.
            message_queue (Optional[janus.SyncQueue], optional): Message queue for streaming. Defaults to None.

        Returns:
            OrchestratorResp: The agent's response.
        """
