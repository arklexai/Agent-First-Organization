...
from arklex.orchestrator.task_graph.task_graph import SubTaskGraphLogic, TaskGraphNLU
...
Answer with only 'yes' or 'no'"""
    ...
    def _get_response(
        ...
        while n_node_performed < max_n_node_performed:
            ...
            curr_node, params, node_info = self.task_graph.preprocess_node(
                taskgraph_inputs, params
            )
            if node_info is not None:
                ...
                if self.task_graph._is_logic_node(curr_node):
                    ...
                    logic_graph = SubTaskGraphLogic(
                        "logic", logic_subgraph_config, curr_node
                    )
