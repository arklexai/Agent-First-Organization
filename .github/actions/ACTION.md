...
- `min-coverage-threshold`: Minimum coverage percentage to pass (default: 95)
...
- `minimum-green`: Minimum coverage percentage for green status (default: 95)
- `minimum-orange`: Minimum coverage percentage for orange status (default: 85)
...
- `min-coverage-threshold`: Minimum coverage threshold for color coding (default: 95)
