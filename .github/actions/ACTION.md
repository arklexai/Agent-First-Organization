...
- `min-coverage-threshold`: Minimum coverage percentage to pass (default: 80)
...
- `minimum-green`: Minimum coverage percentage for green status (default: 80)
...
- `min-coverage-threshold`: Minimum coverage threshold for color coding (default: 80)
