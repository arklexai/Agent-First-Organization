...
def get_coverage_status(
    coverage_percentage: float, min_green: float = 95.0, min_orange: float = 85.0
) -> str:
...
def format_coverage_comment(
    coverage_data: dict[str, Any], min_green: float = 95.0, min_orange: float = 85.0
) -> str:
...
def main() -> None:
    ...
    min_green = float(os.environ.get("MINIMUM_GREEN", "95.0"))
    min_orange = float(os.environ.get("MINIMUM_ORANGE", "85"))
